        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="bloc">
                    ...
                    <a class="btn btn-danger" href="<?= base_url('evenements/nePlusParticiper/') . $evenement[0][0]['nom'] ?>" OnClick="return confirm('Voulez-vous vraiment ne plus participer à cet événement ?');">Ne plus participer</a>
                </div>
            </div>
